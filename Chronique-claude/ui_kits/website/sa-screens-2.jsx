...
function Apropos() {
  return (
    <div className="page">
      <div className="page-hero" style={{ backgroundImage: `url('${window.__r('dining_room_press_jpg')}')` }}>
      ...
      <section className="chapters">
        ...
        <div className="chapter">
          ...
          <div className="chapter__img" style={{ backgroundImage: `url('${window.__r('dining_room_collage_jpg')}')` }} />
        </div>
        ...
        <div className="chapter chapter--flip">
          ...
          <div className="chapter__img" style={{ backgroundImage: `url('${window.__r('dining_room_press_jpg')}')` }} />
        </div>
        ...
        <div className="chapter">
          ...
          <div className="chapter__img" style={{ backgroundImage: `url('${window.__r('facade_night_webp')}')` }} />
        </div>
      </section>
